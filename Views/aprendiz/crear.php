<?php require_once("c://laragon/www/CRUD_APRENDICES/Views/head/head.php"); ?>

<h1 class="text-center mb-4">Agregar Aprendiz</h1>

<form action="/CRUD_APRENDICES/controllers/aprendizController.php?accion=guardar" method="post" class="col-md-6 mx-auto">
...
<script>
    Swal.fire({
        ...
        text: '<?php echo $_GET['success'] == 'true' ? 'Aprendiz guardado correctamente.' : 'No se pudo guardar el aprendiz.'; ?>',
